...
class messager
{
	...
	public:
		...
		void search_sentmsg(user *ptr);
		void search_receivedmsg(user *ptr);
};
...
void messager:: search_sentmsg(user *ptr)
{
    string userNAme;
    ...
    while( ptr1 != NULL)
    {
        ...
        {
           cout<<"Sent messages from "<<ptr1->from<<" to "<<ptr1->to<<":"<<endl;
           cout<<ptr1->text<<endl;
           ptr1 = ptr1->link;
        }
    }
...
void messager:: search_receivedmsg(user *ptr)
{
    string userNAme;
    cout<<"Enter username whose received message you want to check:"<<endl;
    cin>>userNAme;
    msg *ptr1 = ptr->headR;
    while(ptr1 != NULL)
    {
        if(ptr1->from == userNAme)
        {
            cout<<"Received messages from\t"<<ptr1->from<<endl;
            cout<<ptr1->text<<endl;
            ptr1 = ptr1->link;
        }
    }
...
void messager::activity(user *ptr)
{
	...
	do
	{
		...
		switch (ch)
		{
			...
			case 4: search_sentmsg(ptr);//am
				break;

			case 5: search_receivedmsg(ptr);//am
				break;
